...
description: Use when adding, removing, upgrading, or discovering Unity packages programmatically from outside the Editor, including headless or CI installs, registry verification, and package selection by genre, platform, or monetization.
allowed-tools:
  - Bash
  - Read
  - Write
