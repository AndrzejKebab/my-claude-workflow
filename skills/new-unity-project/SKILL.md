...
description: Use when starting a brand-new Unity game or project from scratch, including game jams, greenfield projects, blank projects, and project setup. Guides concept, platform, monetization, Editor installation, project creation, source control, and package setup without scaffolding gameplay code.
allowed-tools:
  - Bash
  - Read
  - Write
